...
$coffee1 = $coffees->fetch(PDO::FETCH_ASSOC);
?>
...
<div class="w3-main" style="margin-left:250px">
    ...
    <div class="w3-row w3-padding-64">
        <form class="w3-container">
            ...
            <input class="w3-input" type="text" value="<?= $coffee1['Coffee_ID'] ?>">

            <label>Coffee Name:</label>
            <input class="w3-input" type="text" value="<?= $coffee1['Coffee_Name'] ?>">

            <label>Grower ID:</label>
            <input class="w3-input" type="text" value="<?= $coffee1['Grower_ID'] ?>">

            <label>Roast:</label>
            <input class="w3-input" type="text" value="<?= $coffee1['Roast'] ?>">

            <label>Caffeine Content:</label>
            <input class="w3-input" type="text" value="<?= $coffee1['Caffeination'] ?>">

            <label>Short Description:</label>
            <input class="w3-input" type="text" value="<?= $coffee1['Short_Desc'] ?>">

            <label>Long Description:</label>
            <textarea class="w3-input"><?= $coffee1['Long_Desc'] ?></textarea>
