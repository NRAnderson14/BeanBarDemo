...
if (isset($_GET['growerid'])) {
    $grower = $dbc->getGrowerByID($_GET['growerid']);
}
if ($grower) {
?>
  <div class="w3-row w3-padding-64">
    <div class="w3-twothird w3-container">
      ...
      <h4 class=w3-text-brown><?= $grower['Location']?></h4>
    </div>
  </div>
  ...
  <div class="w3-row w3-padding-32">
    <div class="w3-twothird w3-container">
      ...
      <h2 class="w3-text-brown"><?=$grower['First_Name'].' '.$grower['Last_Name']?></h2>

      <p><?=$grower['Long_Desc']?></p>
    </div>
  </div>
