...
<nav class="w3-sidebar w3-bar-block w3-collapse w3-large w3-theme-l5 w3-animate-left" id="mySidebar">
  ...
  <a class="w3-bar-item w3-button w3-hover-black" href="stores.php">Winona</a>
...
<div class="w3-main" style="margin-left:250px">
  ...
  <div class="w3-row w3-padding-64">
    <div class="w3-twothird w3-container">
      <h1 class="w3-text-teal">Farm Name Farms</h1>

      <h4 class=w3-text-brown>Middle of nowhere, Brazil</h4>
    </div>
  </div>

  <div class="w3-row w3-padding-32">
    <div class="w3-twothird w3-container">
      <h1 class="w3-text-teal">Operated by:</h1>
      <h2 class="w3-text-brown">John Smith</h2>
