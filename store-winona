...
<div class="w3-main" style="margin-left:250px">
  ...
  <div class="w3-row w3-padding-64">
    <div class="w3-twothird w3-container">
      <h1 class="w3-text-teal">BeanBar Winona</h1>
  ...
  <div class="w3-row">
    <div class="w3-twothird w3-container">
      <h2 class="w3-text-brown w3-margin-bottom" style="margin-bottom:none;">Coffee 1</h2>
      <p class="w3-text-brown w3-large"><em>Caffeine Content: ##mg</em></p>
    </div>

    <div class="w3-twothird w3-container w3-margin-bottom">
        <p class="w3-text-black">
            Description Here. Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Lorem ipsum
  ...
  <div class="w3-row">
    <div class="w3-twothird w3-container">
      <h2 class="w3-text-brown w3-margin-bottom" style="margin-bottom:none;">Coffee 2</h2>
      <p class="w3-text-brown w3-large"><em>Caffeine Content: ##mg</em></p>
    </div>
